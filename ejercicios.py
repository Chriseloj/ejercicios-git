"""
1.Muévete por los directorios de tu sistema y selecciona la carpeta en el que se hizo Hola Mundo 
(Python, JavaScript), comprueba que estás dentro de esa carpeta, viendo la ruta que sigue el sistema.
2. Configura tu nombre y email a nivel global
- Comprueba que los tienes.
- Inicia un repositorio en esa carpeta.
- Averigua cómo ver el fichero oculto '.git'., renombra la rama principal a 'main' programacion.
- Añade los archivos de Hola Mundo, todos al mismo tiempo.
- Verifica que todo este correcto.
3. Modifica el "¡Hola mundo!" de el enunciado y del ejercicio a ¡Hola Git!, añadelos y comentalo, en el mensaje explica cómo 
hiciste este ejercicio, los anteriores, y la dificultad que te costó.
4. En el segundo ejercicio de Hola Mundo, 'Debajo de ¡Hola Git!.
- Borra el enunciado y el ejercicio, deja solo el número. 
- Debajo de el dos,haz un reto de programación, terminalo, guardalo, pon la dificultad que te costó hacerlo.
- Una vez terminado te das cuenta de que, no lo tenías que hacer aquí, vuelve a la versión anterior.
- Deja el reto en espera con un mensaje cómo 'challenge: el nombre de el reto' dentro del commit de espera.   
